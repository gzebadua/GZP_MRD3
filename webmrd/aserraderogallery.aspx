<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="aserraderogallery.aspx.vb" Inherits="WebMRD.aserraderogallery" %>
...
<head runat="server">
    ...
    <title runat="server" id="PageTitle">Centro Productivo - Galer&iacute;a - Maderer&iacute;a R&iacute;o Dorado</title>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="pnlContent" runat="server" 
            ...
            <asp:UpdatePanel ID="updPnlMenuLeft" runat="server" ChildrenAsTriggers="true" UpdateMode="Always">
                <ContentTemplate>
                    ...
                    <asp:Panel ID="pnlMenuLeft" runat="server" 
                        ...
                        left: 0px; position: absolute; width: 234px; height: 613px;  
            ...
            <asp:UpdatePanel ID="updPnlBrown" runat="server" ChildrenAsTriggers="true" UpdateMode="Always">
                <ContentTemplate>
                    <asp:Panel ID="pnlBrown" runat="server" Height="409px" Width="558px" BackImageUrl="images/web_11.jpg" 
            ...
            <asp:UpdatePanel ID="updPnlRestrictions" runat="server" ChildrenAsTriggers="true" UpdateMode="Always">
                <ContentTemplate>
                    <asp:Panel ID="pnlRestrictions" runat="server" Visible="False" Width="583px" Style="z-index: 102; top: 144px; left: 240px; position: absolute; vertical-align:middle; text-align:justify;">
                        &nbsp;
                        <asp:Image ID="imgBrowser" runat="server" ImageAlign="AbsMiddle" />
                        &nbsp;
                        <asp:Label ID="lblRestrictions" runat="server" ForeColor="Red" Font-Size="8pt">¿Quieres ver las fotos como una presentaci&oacute;n? <a href="aserradero.aspx" target="_self">Haz Click Aqu&iacute;</a></asp:Label>
                    </asp:Panel>
                </ContentTemplate>
            </asp:UpdatePanel>
            ...
            <asp:UpdatePanel ID="updPnlSlideShow" runat="server" ChildrenAsTriggers="true" UpdateMode="Always">
                <ContentTemplate>
                    <asp:Panel ID="pnlSlideShow" runat="server" Width="448px" Height="299px" Style="z-index: 102; top: 165px; left: 240px; position: absolute; vertical-align:text-bottom; text-align:left;">
                        <asp:DataList ID="dlImages" runat="server" RepeatColumns="7" RepeatDirection="Horizontal" RepeatLayout="Table" ShowFooter="False" ShowHeader="False" DataKeyField="iimageid" HorizontalAlign="Center">
                            <ItemTemplate>
                                <div style="text-align:center;">
                                    <a target="_blank" href='<%#DataBinder.Eval(Container.DataItem, "slargeimageurl")%>'>
                                        <asp:Image ID="imgLink" runat="server" ImageAlign="Top" ImageUrl='<%#DataBinder.Eval(Container.DataItem, "simageurl")%>' />
                                    </a>
                                </div>
                            </ItemTemplate>
                        </asp:DataList>
            ...
            <asp:UpdatePanel ID="updPnlSheet" runat="server" ChildrenAsTriggers="true" UpdateMode="Always">
               <ContentTemplate>
                   <asp:Panel ID="pnlSheet" runat="server" BackImageUrl="images/web_10_larger.jpg" 
                       Style="z-index: 100; top: 123px; left: 793px; position: absolute; height: 429px; width: 206px; vertical-align:middle; text-align:justify; background-repeat:no-repeat;">
                   </asp:Panel>
               </ContentTemplate>
            </asp:UpdatePanel>
            ...
            <asp:UpdatePanel ID="updPnlGreen" runat="server" ChildrenAsTriggers="true" UpdateMode="Always">
                <ContentTemplate>
                    <asp:Panel ID="pnlGreen" runat="server" BackImageUrl="images/web_12.jpg" Width="763px" Height="95px" Style="z-index: 100; top: 552px; left: 235px; position: absolute; vertical-align:middle; text-align:justify; background-repeat:repeat-x;">
            ...
            <asp:UpdatePanel ID="updPnlInfo" runat="server" ChildrenAsTriggers="true" UpdateMode="Always">
                <ContentTemplate>
                    <asp:Panel ID="pnlInfo" runat="server" Width="755px" Height="82px" Style="z-index: 101; top: 557px; left: 238px; position: absolute; vertical-align:middle; text-align:justify;">
            ...
            <asp:UpdatePanel ID="updPnlCopyrightBar" runat="server" ChildrenAsTriggers="true" UpdateMode="Always">
                <ContentTemplate>
                    <asp:Panel ID="pnlCopyrightBar" runat="server" Width="764px" BackImageUrl="images/web_14.jpg" 
                        Style="z-index: 100; top: 647px; left: 234px; position: absolute; vertical-align:middle; text-align:justify; height: 42px;">
            ...
            <asp:UpdatePanel ID="updPnlCopyright" runat="server" ChildrenAsTriggers="true" UpdateMode="Always">
                <ContentTemplate>
                    <asp:Panel ID="pnlCopyright" runat="server" Width="761px" Height="30px" Style="z-index: 101; top: 652px; left: 234px; position: absolute; vertical-align:middle; text-align:center;">
            ...
            <asp:UpdatePanel ID="updPnlCCLicence" runat="server" ChildrenAsTriggers="true" UpdateMode="Always">
                <ContentTemplate>
                    <asp:Panel ID="pnlCCLicence" runat="server" Width="80px" Height="15px" Style="z-index:101; top: 648px; left:0px; position:absolute; vertical-align:middle; text-align:justify;"> 
