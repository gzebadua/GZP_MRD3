Partial Public Class aserraderogallery
        ...
        If Not Page.IsPostBack Then
            ...
            Else
                ...
                If Session("preferredLanguage") = "esmx" Then
                    pnlSheet.BackImageUrl = "images/web_10_larger.jpg"
                    pnlSlogan.BackImageUrl = "images/web_08.jpg"
                ElseIf Session("preferredLanguage") = "enus" Then
                    pnlSheet.BackImageUrl = "images/web_10_larger_en.jpg"
                    pnlSlogan.BackImageUrl = "images/web_08_en.jpg"
                End If
                ...
                fillDataListNotPaged(dlImages, "SELECT iimageid, REPLACE(simageurl, 'productionfacilityimages', 'productionfacilityimages/smaller') AS simageurl, REPLACE(simageurl, 'productionfacilityimages', 'productionfacilityimages/larger') AS slargeimageurl FROM productionfacilityimages")
    ...
    <System.Web.Services.WebMethod(), System.Web.Script.Services.ScriptMethod()> Public Shared Function GetSlides() As AjaxControlToolkit.Slide()
        ...
        Dim countingHouses As Integer = getSQLQueryAsInteger("SELECT COUNT(*) from productionfacilityimages")
        ...
        'limitNumber1 = getSQLQueryAsInteger("SELECT MAX(iimageid) FROM productionfacilityimages")
        ...
        dsImages = getSQLQueryAsDataset("SELECT iimageid, simageurl FROM productionfacilityimages")
